...
{
    public function sturegStore(Request $request)
    {
        $messages = [
        ...
        if ($user->stop === "no") {
            ...
            // Fetch the academic year to check its name
            ...
            $studentNRCImage = $request->file('student_nrc_photo'); // New field
            $studentNRCBackImage = $request->file('student_nrc_back'); // New field
            ...
            $studentNRCImageName = uniqid() . 'student_nrc_' . $studentNRCImage->getClientOriginalName(); // New field
            $studentNRCBackImageName = uniqid() . 'student_nrc_back_' . $studentNRCBackImage->getClientOriginalName(); // New field
            ...
            $studentNRCImage->storeAs('public/images', $studentNRCImageName); // New field
            $studentNRCBackImage->storeAs('public/images', $studentNRCBackImageName); // New field
            ...
            $studentRegistration = new StudentRegistration([
                ...
                'student_nrc_photo' => $studentNRCImageName, // New field
                'student_nrc_back' => $studentNRCBackImageName, // New field
